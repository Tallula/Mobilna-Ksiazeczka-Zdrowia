...
public  class Linki{
    ...
    public static String pobieranieLeczenieFolder = "Leczenie/";
    ...
    public static String zwrocPobieranieLeczenieFolder(){ return adres +projekt + pobieranieLeczenieFolder; }
